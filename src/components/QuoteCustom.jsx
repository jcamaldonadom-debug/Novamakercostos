...
import { MATERIALS, POST_PROCESSING_ITEMS, DEFAULT_MARGIN, WHOLESALE_MARGIN } from '../config/config.js'
import {
  calcPrintCost,
  calcPostProcessing,
  calcPrice,
...
export default function QuoteCustom({ currentUser, onSaved, onBack }) {
  ...
  const calc = useMemo(() => {
    ...
    return { printCost, ppTotal, variablePerPiece, precioPieza, precioTotal, variableTotal, margenReal }
  }, [form, postEnabled, postItems])
